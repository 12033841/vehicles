...
class Vehicle2(turtle.Turtle):
    ...
    def get_input_information(self, position):
        ...
        # distance from HeatSource position to new-created vehicle
        input_angle = self.heading() - self.towards(position)
        # direction difference between new-created vehicle and HeatSource (direction).
    ...
    def move(self):
            ...
            self.moves += 1
            # record the times the turtle move(change the direction and move)
...
# input_list consists of HeatSource.
